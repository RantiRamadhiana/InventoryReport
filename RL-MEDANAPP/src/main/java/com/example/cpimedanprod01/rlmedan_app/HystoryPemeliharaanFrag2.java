...
public class HystoryPemeliharaanFrag2 extends Fragment {
    View rootView;
    ...
    static String ipadd,usernm,idalatinst;
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        idalatinst = getArguments().getString("idalat");
        barcodeText.setText(idalatinst);
        ipadd2.setText(ipadd);
        ontagreader(idalatinst);
        return rootView;
    }
    ...
    public final void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(HystoryPemeliharaanFrag2.this.getContext(), Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
    ...
    public void ontagreader(String idmaterial) {
        ...
        class ReadTag extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(HystoryPemeliharaanFrag2.this.getContext(), "Loading...", "Waiting...", false, false);
            }
            ...
            protected void onPostExecute(String s) {
                if (s == "") {
                    ...
                    SpannableStringBuilder biggerText = new SpannableStringBuilder(txt);
                    biggerText.setSpan(new RelativeSizeSpan(1.35f), 0, txt.length(), 0);
                    Toast.makeText(HystoryPemeliharaanFrag2.this.getContext(), biggerText, Toast.LENGTH_LONG).show();
                    namabrg2.setText("-");
                    idmat2.setText("");
                } else {
                    super.onPostExecute(s);
